...
public enum BinaryOperatorRule {
    ...
    BANG_EQ_INT_INT(BinaryOperator.NOT_EQ, WholeNumber.class, WholeNumber.class, Integer.class),
    BANG_EQ_POINTER_POINTER(BinaryOperator.NOT_EQ, Pointer.class, Pointer.class, Integer.class, AdditionalRule.IP_VOID_NULL_POINTER),
