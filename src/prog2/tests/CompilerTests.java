...
public class CompilerTests {
	...
	protected class ASTMaker {
		...
		public Statement createWhile(final Expression cond, final Statement body) {
			return astFactory.createWhileStatement(l, cond, body, null, null);
		}

		public Statement createWhile(final Expression cond, final Statement body, final Expression invariant) {
			return astFactory.createWhileStatement(l, cond, body, invariant, null);
		}

		public Statement createWhile(final Expression cond, final Statement body, final Expression invariant,
				final Expression term) {
			return astFactory.createWhileStatement(l, cond, body, invariant, term);
		}
